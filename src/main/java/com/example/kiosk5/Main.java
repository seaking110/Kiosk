...
public class Main {
    public static void main(String[] args) {
        ...
        menu.add(burgerMenu);
        burgerMenu.addMenuItem(new MenuItem("Thigh Burger",4.9, "바삭한 치킨 패티와 양상추가 조화를 이루는 맘스터치 시그니처 버거."));
        burgerMenu.addMenuItem(new MenuItem("Fire Thigh Burger",5.1, "불맛이 살아있는 버거, 싸이버거의 매운맛 버전."));
        burgerMenu.addMenuItem(new MenuItem("White Garlic Burger",5.5, "화이트 갈릭소스에 더블햄과 통가슴살 패티까지 담은 버거."));
